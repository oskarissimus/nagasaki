...
from nagasaki.clients.bitclude_client import AccountInfo, Balance, Offer
...
def initialized_state() -> State:
    ...
    state = State()
    state.btc_mark_usd = Decimal(btc_price_detibit)
...
def test_bidding_over_epsilon_simple_case(initialized_state: State):
